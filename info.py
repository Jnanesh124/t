...
AUTH_CHANNEL_2 = -1001764441595
AUTH_CHANNEL_3 = -1001802232305
AUTH_CHANNEL_4 = -1002073975172
AUTH_CHANNEL_5 = -1001868749404
...
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'rockers-disc.xyz')
SHORTLINK_API = environ.get('SHORTLINK_API', '77068712fda060047b3f1389aa85f958a22599de')
IS_SHORTLINK = is_enabled((environ.get('IS_SHORTLINK', 'False')), False)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "4")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+5TJUbOMCqD05ZmQ1')
